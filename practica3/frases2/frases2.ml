...
(function x -> x-y) y;;   (*let x=y in x-y;; *)
(* -: int = 0 *)
...
(function y -> x+y) (5);;  (* let y=5 in x+y;; *)
(* -: int = 10 *)
...
(function x -> function y -> function z -> (x + y) * (x * y) + z);;   (* let x = x + y in let y= x * y in x + y + z;; *)    
...
let istrue = function true -> true;;  (* la función solo devulve true cuando su argumento es true, pero no tienen ningún manejo para los valores que no sean true *)
